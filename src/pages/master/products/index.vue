    ...
    <div>
            ...
            <div class="sm:w-1/1 md:w-2/3 flex flex-col mb-10 space-y-10">
                <div class="flex justify-between">
                    <div class="flex space-x-3">
                        ...
                        <span class="text-2xl font-bold text-red-800">กำหนดข้อมูลสินค้า</span>
                    </div>

                    <div class="flex space-x-3">
                        <buttonPrimary label="เพิ่มสินค้า" icon="plus" @click="onOpenModal('add')" />
        ...
        <dialog id="modal-employee" class="modal">
            <div class="modal-box w-11/12 max-w-3xl ">
                <h3 class="font-bold text-lg">{{ modeModal === 'add' ? 'เพิ่มสินค้า' : 'แก้ไขสินค้า' }}</h3>
