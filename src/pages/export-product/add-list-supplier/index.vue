        ...
        <div class="grid grid-cols-2 gap-4 px-6">
            ...
            <div class="flex flex-col md:flex-row space-x-2">
              <div class="grid gap-4 grid-cols-2">
                <div class="mb-3">
                  ...
                  <input class="h-8 w-full focus:outline-red-400 rounded bg-red-100 px-3" type="text" />
                </div>
                <div class="mb-3">
                  <span class="text-red-800 font-semibold">วันที่ขอเบิกสินค้า</span>
                  <input class="h-8 w-full focus:outline-red-400 rounded bg-red-100 px-3" type="date" />
                </div>
              </div>
            </div>
            <div class="flex flex-col md:flex-row space-x-2">
          ...
          <div class="flex flex-col justify-center items-center space-y-2 py-2">
            ...
            <div class="flex flex-row-3">
              ...
              <span class="text-red-800 text-sm text-center px-5">1,500 </span>

              <span class="text-red-800 text-sm text-center">บาท </span>
            </div>
            <div class="flex flex-row-3">
              <span class="text-red-800 text-sm text-center px-10">ค่าขนส่ง
              </span>
              <span class="text-red-800 text-sm text-center px-5">50 </span>
            ...
            <div class="flex flex-row-3 justify-center">
              ...
              <span class="text-red-800 text-sm text-center px-5">1,400 </span>
